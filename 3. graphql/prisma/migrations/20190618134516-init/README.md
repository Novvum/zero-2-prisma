# Migration `20190618134516-init`

This migration has been generated by Rohit at 6/18/2019, 1:45:16 PM.
...
You can use a specific Photon built for this migration (20190618134516-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20190618134516-init'
